...
void crop_thread::run()
{
    ...
    QObject::connect(this,SIGNAL(init(QString,int)),&crop_ocr_obj,SLOT(on_init(QString,int)));
    QObject::connect(this,SIGNAL(rotate(QString,int,int)),&crop_ocr_obj,SLOT(on_rotate(QString,int,int)));
    QObject::connect(this,SIGNAL(crop_ocr(QString,QVariant,int)),&crop_ocr_obj,SLOT(on_crop_ocr(QString,QVariant,int)));
